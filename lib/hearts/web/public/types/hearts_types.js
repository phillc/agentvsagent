...
AgentVsAgent.Card = function(args) {
  this.suit = null;
  this.rank = null;
  if (args) {
...
AgentVsAgent.Trick = function(args) {
  this.leader = null;
  this.played = null;
  if (args) {
...
AgentVsAgent.Trick.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.leader = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AgentVsAgent.RoundResult = function(args) {
  this.north = null;
  this.east = null;
  this.south = null;
  this.west = null;
...
AgentVsAgent.RoundResult.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.north = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 3:
      if (ftype == Thrift.Type.I32) {
        this.south = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AgentVsAgent.OutOfSequenceException = function(args) {
  this.message = null;
  if (args) {
    if (args.message !== undefined) {
      this.message = args.message;
...
AgentVsAgent.InvalidMoveException = function(args) {
  this.message = null;
  if (args) {
    if (args.message !== undefined) {
      this.message = args.message;
...
AgentVsAgent.CURRENT_VERSION = '0.0.10';
