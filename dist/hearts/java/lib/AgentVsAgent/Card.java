...
public class Card implements org.apache.thrift.TBase<Card, Card._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Card other) {
    ...
    Card typedOther = (Card)other;

    lastComparison = Boolean.valueOf(isSetSuit()).compareTo(typedOther.isSetSuit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSuit()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.suit, typedOther.suit);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
