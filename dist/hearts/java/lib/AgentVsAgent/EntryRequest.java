...
public class EntryRequest implements org.apache.thrift.TBase<EntryRequest, EntryRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(EntryRequest other) {
    ...
    EntryRequest typedOther = (EntryRequest)other;
